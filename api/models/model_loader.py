from . import ingredients, low_stocks_alerts, menu_item_ingredients, menu_items, order_items, orders, promo_codes, reviews
from ..dependencies.database import engine

def index():
    ingredients.Base.metadata.create_all(engine)
    low_stocks_alerts.Base.metadata.create_all(engine)
